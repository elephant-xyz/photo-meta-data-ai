...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("logs/ai-analyzer.log"), logging.StreamHandler()],
)
...
def analyze_images_with_quality(
    image_paths: List[str], output_dir: str, prompt: str = None, schemas: Dict = None
) -> Dict[str, Any]:
...
def main():
    ...
    results = analyze_images_with_quality(image_paths, args.output_dir, similarity_threshold=args.similarity_threshold)
