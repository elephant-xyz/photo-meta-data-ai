...
def summarize_layouts(output_dir: str) -> Dict:
    ...
    layouts_summary = {"total_layouts": 0, "space_types": [], "details": []}
...
def summarize_structure(output_dir: str) -> Dict:
    ...
    structure_summary = {"file_found": False, "details": {}}
        ...
        if data:
            ...
            structure_summary["details"] = {
                ...
                "construction_material": data.get(
                    "exterior_wall_material_primary", data.get("construction_material", "unknown")
                ),
...
def summarize_lot(output_dir: str) -> Dict:
    ...
    lot_summary = {"file_found": False, "details": {}}
    ...
    if lot_file.exists():
        ...
        if data:
            ...
            lot_summary["details"] = {
                ...
                "lot_dimensions": f"{data.get('lot_length_feet', 'unknown')} x {data.get('lot_width_feet', 'unknown')}"
                if data.get("lot_length_feet") and data.get("lot_width_feet")
                else data.get("lot_dimensions", "unknown"),
...
def summarize_utility(output_dir: str) -> Dict:
    ...
    utility_summary = {"file_found": False, "details": {}}
...
def summarize_appliances(output_dir: str) -> Dict:
    ...
    appliances_summary = {"total_appliances": 0, "appliance_types": [], "details": []}
...
def print_summary(property_id: str, summary: Dict):
    ...
    if summary["appliances"]["appliance_types"]:
        ...
        valid_appliance_types = [
            at for at in summary["appliances"]["appliance_types"] if at and at != "unknown" and at != "None"
        ]
        ...
        for appliance in summary["appliances"]["details"]:
            ...
            if appliance_type and appliance_type != "unknown" and appliance_type != "None":
                ...
                condition_info = (
                    f" ({condition})" if condition and condition != "unknown" and condition != "None" else ""
                )
