#!/usr/bin/env python3
"""
Prepare Submit Data Script

This script handles the preparation of data for submission:
1. Copy data from output to submit folder
2. Rename folders to propertyCID from upload results
3. Copy property.json files from submit.zip
"""
...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("logs/prepare-submit.log"), logging.StreamHandler()],
)
...
def load_environment():
    ...
    if os.path.exists(env_file):
        ...
        logger.info(f"⚠️  No .env file found at {env_file}")
...
def main():
    ...
    logger.info("🚀 Starting data preparation for submission...")
    ...
    # Step 4: Copy property.json files from submit.zip after folder renaming
